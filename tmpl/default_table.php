...
?><div id="quicklinksTable>" class="<?php echo $v;?>">
    ...
    <ul>
    <?php
    if (!is_array($obj_plugin->$v) AND !is_object($obj_plugin->$v)) : echo sprintf(JText::_('MOD_QLDEBUG_TABLENOTFOUND'),(string)$params->get('tablename'));
    else :
    ...
    <?php /*PRE STOP*/ if (1==$params->get('pre')) echo '</pre>';?>
</div>